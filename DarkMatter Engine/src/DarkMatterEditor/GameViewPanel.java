...
public class GameViewPanel {
    ...
    public void imgui() {
        ...
        if (ImGui.menuItem("Play", "", isPlaying, !isPlaying)) {
            isPlaying = true;
            EventSystem.notify(null, new Event(CoreEngine.Observers.Events.EventType.GameEngineStartPlay));
        }
        if (ImGui.menuItem("Stop", "", !isPlaying, isPlaying)) {
            isPlaying = false;
            EventSystem.notify(null, new Event(CoreEngine.Observers.Events.EventType.GameEngineStopPlay));
        }
        ImGui.endMenuBar();
